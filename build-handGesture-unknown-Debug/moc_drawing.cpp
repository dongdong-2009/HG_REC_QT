...
static const char qt_meta_stringdata_Drawing[] = {
    "Drawing\0\0on_toolButton_backMainWindow_clicked()\0"
};
...
const QMetaObjectExtraData Drawing::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Drawing::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Drawing,
      qt_meta_data_Drawing, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Drawing::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Drawing))
